...
public class US005 {
    ...
    public void mb_click_the_ssn_textbox_and_enter_ssn_number(String string) {
    ...
    public void mb_click_email_textbox_and_enter_a_valid_email_address(String string) {
    ...
    public void mb_click_the_phone_textbox_and_enter_a_valid_phone_number(String string) {
