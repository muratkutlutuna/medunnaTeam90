...
public class US005{
    ...
    public void mb_click_the_make_an_appointment_button() throws InterruptedException {
    ...
    public void mb_click_first_name_textbox_and_enter_first_name(String mfirstname) throws InterruptedException {
    ...
    public void mb_verify_first_name_textbox_is_not_blank() {
       // Assert.assertFalse(mehlikaPage.firstNameWarning.isDisplayed());
